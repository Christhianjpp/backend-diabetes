...
const combinacionesUtilizadas = new Set<string>();
 ...
 */
export const userName = (name: string, maxLength: number = 15): string => {
 ...
 */
function generarCombinacionUnica(length: number = 5): string {
